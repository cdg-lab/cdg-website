...
const content = `
I am an Associate Professor of [Computer Science](https://cs.brown.edu/) at [Brown University](https://brown.edu/) and a member of the [Brown Visual Computing](https://visual.cs.brown.edu/) group. I am also an affiliate faculty member at the [Paul G. Allen School of Computer Science & Engineering](https://www.cs.washington.edu/) at the [University of Washington](https://www.washington.edu/).

My research group creates design tools and systems that aim to transform how we build physical artifacts. A central challenge for design tools in manufacturing is the need to simultaneously nurture the creative ability to conceive novel designs and the analytical capacity to critically evaluate and optimize functionality and production. My group tackles this challenge through innovative solutions that are grounded in the fundamentals of geometry processing and combine insights from machine learning and programming languages.
