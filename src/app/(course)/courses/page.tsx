            ...
            {courses.map((course) => (
              ...
              >
                <div className='flex justify-between items-start mb-4'>
                  <div>
                    <h2 className='text-2xl font-bold text-stone-800 group-hover:text-blue-600 transition-colors'>
                      {course.code}
                    </h2>
                ...
                <div className='mt-4 text-blue-600 group-hover:text-blue-700 font-medium text-sm'>
                  View course details →
                </div>
              </Link>
            ))}
